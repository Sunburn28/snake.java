    ...
    public class ImagenSnake extends JPanel {
        public void paintComponent(Graphics g) {
            super.paintComponent(g);
               g.drawString("Tu puntuacion es :  "+(listaPosiciones.size()-1), 600, 500);
            ...
            if(gameOver) {
                ...
                g.drawString("Fin del juego mi rey", 300, 200);
                g.drawString("Tu puntuacion es :  "+(listaPosiciones.size()-1), 600, 500);

                g.setFont(new Font("TimesRoman", Font.BOLD, 20));
                g.drawString("Pulsa N para reinicar el juego", 100, 320);
                g.drawString("Pulsa ESC para salir finalizar", 100, 340);
            }
